...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-56 bg-white border-r border-gray-200 min-h-screen sticky top-0 h-screen select-none overflow-y-auto">
      ...
      {/* Footer */}
      <div className="px-4 py-3 border-t border-gray-100 text-[11px] text-gray-400 font-medium flex items-center justify-between">
        <span>v2.0</span>
        <button
          onClick={logout}
          className="text-gray-400 hover:text-red-500 font-medium transition text-[11px]"
        >
          Sign out
        </button>
      </div>
