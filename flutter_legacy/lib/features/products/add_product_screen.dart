    ...
    return ScreenShell(
      ...
      body: Form(
        ...
        child: ListView(
          children: [
            // ── Product Type ──────────────────────────────────────────────
            const _SectionHeader('Product Type'),
            ...
            // ── Basic Info ────────────────────────────────────────────────
            const _SectionHeader('Product Information'),
            const SizedBox(height: AppSpacing.md),
            AppTextField(
              label: 'Product Name *',
            ...
            if (_productType.hasPack) ...[
              const _SectionHeader('Pack Configuration'),
              const SizedBox(height: AppSpacing.md),
              AppTextField(
            ...
            // ── GST Rate ──────────────────────────────────────────────────
            const _SectionHeader('Default GST Rate'),
            const SizedBox(height: AppSpacing.sm),
            Text(
            ...
            // ── Classification ────────────────────────────────────────────
            const _SectionHeader('Drug Schedule'),
            const SizedBox(height: AppSpacing.md),
            Wrap(
              spacing: 8,
              runSpacing: 8,
