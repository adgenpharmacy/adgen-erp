                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: AlphabetScrollbar(
                        ...
                        estimatedItemHeight: 90, // approx height of _ProductCard
                      ),
                    ),
                  ],
                ),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              if (isOut)
                const StatusChip(label: 'Out of Stock', type: StatusType.error, small: true)
              else if (isLow)
                const StatusChip(label: 'Low Stock', type: StatusType.warning, small: true)
              else
                const StatusChip(label: 'In Stock', type: StatusType.success, small: true),
            ],
          ),
        ],
      ),
