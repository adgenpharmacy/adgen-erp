                            ...
                            child: AppCard(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Flexible(child: Text('Total Payable (We Owe)', style: AppTypography.caption.copyWith(color: AppColors.error))),
                                      const SizedBox(width: 4),
                                      Tooltip(
                                        message: "Sum of all unpaid debit entries (vendor bills)",
                                        textStyle: AppTypography.caption.copyWith(color: AppColors.surface),
                                        child: Icon(Icons.info_outline_rounded, size: 12, color: AppColors.error.withValues(alpha: 0.7)),
                                      ),
                                    ],
                                  ),
                            ...
                            child: AppCard(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Flexible(child: Text('Total Receivable (Owed to Us)', style: AppTypography.caption.copyWith(color: AppColors.success))),
                                      const SizedBox(width: 4),
                                      Tooltip(
                                        message: "Sum of all unpaid credit entries (customer credit)",
                                        textStyle: AppTypography.caption.copyWith(color: AppColors.surface),
                                        child: Icon(Icons.info_outline_rounded, size: 12, color: AppColors.success.withValues(alpha: 0.7)),
                                      ),
                                    ],
                                  ),
                            ...
                            child: AppCard(
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Flexible(child: Text('Net Balance', style: AppTypography.caption)),
                                      const SizedBox(width: 4),
                                      Tooltip(
                                        message: "Absolute difference between Total Receivable and Total Payable",
                                        textStyle: AppTypography.caption.copyWith(color: AppColors.surface),
