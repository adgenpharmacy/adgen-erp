            ...
            ...returns.map((r) => Padding(
              ...
              child: AppCard(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    '${DateFormat('dd MMM yyyy').format(r.returnDate)} • ${r.reason.displayName}',
                    style: AppTypography.caption,
                  ),
                  const SizedBox(height: 4),
                  Text(
                    '${r.items.length} item(s) returned • Refund: ${AppFormatters.formatCurrency(r.totalRefundAmount)} via ${r.refundMethod.toUpperCase()}',
