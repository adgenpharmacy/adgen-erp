    ...
    return AppCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const StatusChip(label: 'Pending', type: StatusType.warning, small: true),
        ]),
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton.icon(
                              onPressed: () => _showPinDialog('Run Database Sync (PIN: 2659)', () {
                                ref.read(dataOpsNotifierProvider.notifier).syncAllLegacyData();
                              }),
                              icon: const Icon(Icons.sync_rounded),
                              label: const Text('Run Full Database Sync'),
                              style: ElevatedButton.styleFrom(
                                padding: const EdgeInsets.symmetric(vertical: 16),
              ...
              AppCard(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    const Icon(Icons.archive_rounded, color: AppColors.primary, size: 22),
                    const SizedBox(width: AppSpacing.sm),
              ...
              AppCard(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    const Icon(Icons.unarchive_rounded, color: AppColors.warning, size: 22),
                    const SizedBox(width: AppSpacing.sm),
